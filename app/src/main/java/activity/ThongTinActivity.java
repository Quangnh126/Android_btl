...
//        mapFragment.getMapAsync(this);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng uit = new LatLng(10.870305, 106.803435);
        mMap.addMarker(new MarkerOptions().position(uit).title("Học viện Công nghệ Bưu chính Viễn thông").snippet("Số 10, đường Nguyễn Trãi, Q.Hà Đông, TP.Hà Nội.").icon(BitmapDescriptorFactory.defaultMarker()));
